...
function CarouselDots({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      role="tablist"
      className={cn(
        "absolute pt-0.5 w-full flex items-center justify-center gap-2",
        className
      )}
      {...props}
    >
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute size-8 rounded-full cursor-pointer transition-transform duration-200 ease-out hover:scale-110 hover:bg-white/20",
        orientation === "horizontal"
